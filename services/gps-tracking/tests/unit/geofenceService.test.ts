...
// Mock shapesReader so checkDeviation tests can proceed past the polyline guard
jest.mock('../../src/services/shapesReader', () => ({
  shapesReader: {
    getPolylineForRoute: jest.fn().mockResolvedValue([
      { lat: 43.7, lng: -79.5 },
      { lat: 43.8, lng: -79.6 },
    ]),
  },
