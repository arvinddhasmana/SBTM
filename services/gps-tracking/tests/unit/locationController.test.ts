...
// Mock SystemSettingService so that ingestLocation proceeds as if GPS source
// is DRIVER_APP — no real Prisma connection required in unit tests.
jest.mock('../../src/services/systemSettingService', () => ({
  SystemSettingService: {
    getGpsTrackingSource: jest.fn().mockResolvedValue('DRIVER_APP'),
