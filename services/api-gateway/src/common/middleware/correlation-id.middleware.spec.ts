...
describe('CorrelationIdMiddleware', () => {
    ...
    it('should propagate an incoming x-request-id header unchanged', () => {
        ...
        expect(mockRes.setHeader).toHaveBeenCalledWith(CORRELATION_ID_HEADER, incomingId);
    ...
    it('should generate a new UUID when x-request-id header is absent', () => {
        ...
        expect(mockRes.setHeader).toHaveBeenCalledWith(CORRELATION_ID_HEADER, assignedId);
        expect(mockNext).toHaveBeenCalled();
    });
