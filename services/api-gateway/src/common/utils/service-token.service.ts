...
export class ServiceTokenService {
    ...
    constructor(
        ...
        this.serviceIdentity = this.configService.get<string>('SERVICE_IDENTITY', 'api-gateway');
    }
    ...
    createServiceToken(): string {
        ...
        return this.jwtService.sign(payload, {
            secret: this.configService.get<string>('INTERNAL_SERVICE_SECRET', 'dev_internal_secret'),
            expiresIn: '5m',
        });
    }
