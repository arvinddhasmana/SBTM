...
const mockUserWithChildren = {
    ...
    children: [
        { id: 'child-1', name: 'Child One', schoolName: 'Test School', routeId: 'r-1', vehicleId: 'v-1', status: 'on_bus' as const },
        { id: 'child-2', name: 'Child Two', schoolName: 'Test School', routeId: 'r-2', vehicleId: 'v-2', status: 'at_school' as const },
    ],
};
