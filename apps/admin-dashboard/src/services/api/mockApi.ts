...
const MOCK_ROUTES: Route[] = [
    { id: 'ROUTE-R01', name: 'Riverside Express', schoolId: 'SCH-001', direction: 'AM', startTime: '07:30', estimatedDuration: 45, stops: [], status: 'active' },
    { id: 'ROUTE-R12', name: 'Glebe North', schoolId: 'SCH-001', direction: 'AM', startTime: '07:45', estimatedDuration: 30, stops: [], status: 'active' },
    { id: 'ROUTE-R03', name: 'Kanata Rapid', schoolId: 'SCH-002', direction: 'AM', startTime: '08:00', estimatedDuration: 50, stops: [], status: 'active' },
];
