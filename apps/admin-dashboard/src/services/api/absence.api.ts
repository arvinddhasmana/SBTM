...
export const absenceApi = {
  ...
  async confirmAbsence(id: string): Promise<void> {
    await apiClient.patch(`/api/v1/absences/${id}/confirm`);
  },

  async rejectAbsence(id: string, notes?: string): Promise<void> {
    await apiClient.patch(`/api/v1/absences/${id}/reject`, { notes });
  },
};
