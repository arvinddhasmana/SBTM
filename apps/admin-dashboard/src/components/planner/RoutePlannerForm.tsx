    ...
    <div className="flex flex-col h-full gap-3 overflow-y-auto custom-scrollbar pr-1">
      ...
      <div className="border-t border-slate-700 pt-3">
        ...
        <p className="text-[10px] text-slate-600 mt-1">
          {formSchoolId
            ? `${numberOfStops} stops within 4.5km radius of school`
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex gap-1">
            ...
            <button
              ...
              title="Add stop with manual coordinates"
            >
              <Plus size={10} />
              Manual
            </button>
        ...
        <div className="space-y-1.5">
          {stops.map((stop, idx) => (
            ...
            >
              <div className="flex items-center gap-1.5">
                ...
                {spacingWarnings.has(stop.id) && (
                  <span
                    title="Too close to previous stop (&lt;200m)"
          ...
          {stops.length === 0 && (
            <p className="text-[10px] text-slate-600 text-center py-4">
              No stops yet. Use Auto-Generate, click the map, or add manually.
            </p>
          )}
        </div>
      </div>
      ...
      {optimizationResult && (
        <div className="border-t border-slate-700 pt-3 space-y-1">
          <h4 className="text-xs font-bold text-slate-300">Route Optimization</h4>
          {optimizationResult.polylineGeoJson ? (
            ...
            <p className="text-[10px] text-amber-400">
              Route provider unavailable — showing straight-line connections.
            </p>
          )}
        </div>
      )}
