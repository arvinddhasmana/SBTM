...
export const EventTypeConfigPage: React.FC = () => {
  ...
  const handleDelete = (eventType: string) => {
    if (confirm(`Are you sure you want to delete event type "${eventType}"?`)) {
  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Event Type Configuration</h1>
          <p className="text-gray-400">
            Map emergency event types to alert tiers and configure their properties
          </p>
        </div>
            ...
            {configs && configs.length > 0 ? (
              ...
              <tr>
                <td colSpan={isSuperAdmin ? 6 : 5} className="px-6 py-8 text-center text-gray-400">
                  No event type configurations found.
                  {isSuperAdmin && ' Click "Add Event Type" to create one.'}
                </td>
              </tr>
            )}
          </tbody>
