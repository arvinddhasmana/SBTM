...
> **⚠ Historical — v1 Era.** This module document reflects the v1 API Gateway (v1 entities: `SchoolBoard`, `School`, `Route.polyline`, `Student`, `EmergencyAlert`). For the current v2 schema see [DataModel-v2.md](../Design/DataModel-v2.md).
