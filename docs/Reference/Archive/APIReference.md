...
> **⚠ Historical — v1 Era.** This reference describes v1 API endpoints (pre-v2 cutover). For the current v2 service topology and endpoint surface see [Architecture.md](../Design/Architecture.md).
